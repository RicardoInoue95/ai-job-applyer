...
def step_4():
    ...
    if submit_li and li_email and li_password:
        with st.spinner("Fazendo login no LinkedIn... (pode levar até 30 segundos)"):
            try:
                from jobapplier.applicators.linkedin import BLOCKED_MSG, login_and_save_session
...
def step_6():
    ...
    if (saved_btn or test_btn) and smtp_user and (smtp_pass or saved.get("smtp_pass")):
        email_config = {
            "smtp_host": smtp_host,
